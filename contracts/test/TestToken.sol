// From https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-core/PangolinERC20.sol
...
contract TestToken {
    ...
    function permit(address owner, address spender, uint rawAmount, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(block.timestamp <= deadline, "Png::permit: signature expired");
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) public {
        ...
        require(block.timestamp <= expiry, "Png::delegateBySig: signature expired");
