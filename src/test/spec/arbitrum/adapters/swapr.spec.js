...
async function getEnv(forkBlockNumber) {
    ...
    const adapterArgs = [
        'DxSwapAdapter', swapr.factory, 180_000,
    ]
    const Adapter = await ethers.getContractFactory("DxSwapAdapter")
...
describe('YakAdapter - Swapr', function() {
    ...
    it('Gas-estimate is within limits', async () => {
        const options = [
            ...
            [ tkns.WETH, tkns.WBTC, parseUnits('1', 18) ],
