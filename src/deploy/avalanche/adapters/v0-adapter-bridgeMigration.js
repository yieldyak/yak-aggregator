module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    const NEW_TKNS = [ 
        assets.WETHe, assets.WBTCe, assets.DAIe, assets.USDTe, assets.LINKe, assets.UNIe, assets.SUSHIe, assets.BUSDe 
    ]
    const OLD_TKNS = [
        assets.ETH, assets.WBTC, assets.DAI, assets.USDT, assets.LINK, assets.UNI, assets.SUSHI, assets.BUSD 
    ]
